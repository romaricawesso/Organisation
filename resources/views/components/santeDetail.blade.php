...
@section('title', 'Caravane de Santé')

@section('content')

{{-- BREADCRUMB --}}
<div class="breadcumb-area"
     style="background-image: url('{{ asset('assets/images/sante.jpeg') }}');
    ...
    <div class="container" style="position:relative;z-index:2;">
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="brpt"><h2>Caravane de Santé</h2></div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12">
                <div class="event-detail-card">
                    ...
                    <div class="event-detail-img">
                        ...
                        <div class="event-detail-badge sante">
                            <i class="fas fa-heartbeat"></i> Santé
                        </div>
                    </div>

                    <div class="event-detail-meta">
                        <span><i class="fas fa-calendar-alt"></i> 2 Décembre 2024</span>
                        <span><i class="fas fa-clock"></i> 7h00 - 14h00</span>
                        <span><i class="fas fa-map-marker-alt"></i> Lomé, Togo</span>
                        <span><i class="fas fa-users"></i> Gratuit & Ouvert à Tous</span>
                    </div>

                    <h1 class="event-detail-title">
                        Caravane de Santé — Accès aux Soins pour les Familles Vulnérables
                    </h1>
                    <div class="gold-divider"></div>

                    <div class="event-detail-content">
                        <p>Francis + Benedict organise une caravane de santé gratuite pour les familles des quartiers défavorisés de Lomé. Des médecins bénévoles, infirmiers et agents de santé communautaire seront présents toute la journée pour offrir des consultations, dépistages et vaccinations.</p>
                        <p>Cet événement s'inscrit dans notre mission d'améliorer l'accès aux soins de santé pour les communautés les plus vulnérables du Togo, notamment les veuves, les orphelins et les familles à faible revenu.</p>

                        <h3>Programme de la Journée</h3>
                        <div class="event-program-list">
                            <div class="program-item">
                                <span class="program-time">07h00</span>
                                <div class="program-info">
                                    <h5>Ouverture du Site & Accueil</h5>
                                    <p>Installation des tentes médicales et accueil des premiers patients.</p>
                                </div>
                            </div>
                            <div class="program-item">
                                <span class="program-time">07h30</span>
                                <div class="program-info">
                                    <h5>Consultations Médicales Générales</h5>
                                    <p>Consultations gratuites avec des médecins généralistes bénévoles.</p>
                                </div>
                            </div>
                            <div class="program-item">
                                <span class="program-time">08h00</span>
                                <div class="program-info">
                                    <h5>Dépistages Gratuits</h5>
                                    <p>Dépistage du diabète, hypertension, paludisme et VIH.</p>
                                </div>
                            </div>
                            <div class="program-item">
                                <span class="program-time">09h00</span>
                                <div class="program-info">
                                    <h5>Vaccination des Enfants</h5>
                                    <p>Campagne de vaccination pour les enfants de 0 à 5 ans.</p>
                                </div>
                            </div>
                            <div class="program-item">
                                <span class="program-time">10h00</span>
                                <div class="program-info">
                                    <h5>Sensibilisation à l'Hygiène</h5>
                                    <p>Ateliers sur l'hygiène corporelle, alimentaire et domestique.</p>
                                </div>
                            </div>
                            <div class="program-item">
                                <span class="program-time">11h00</span>
                                <div class="program-info">
                                    <h5>Santé Maternelle & Infantile</h5>
                                    <p>Consultations spéciales pour les femmes enceintes et les nourrissons.</p>
                                </div>
                            </div>
                            <div class="program-item">
                                <span class="program-time">13h00</span>
                                <div class="program-info">
                                    <h5>Distribution de Médicaments</h5>
                                    <p>Distribution gratuite de médicaments essentiels aux familles dans le besoin.</p>
                                </div>
                            </div>
                            <div class="program-item">
                                ...
                                <div class="program-info">
                                    <h5>Clôture</h5>
                                    <p>Bilan de la journée et remerciements aux équipes médicales bénévoles.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="event-actions-list">
                            <div class="event-action-item">
                                ...
                                <div>
                                    <h5>Consultations Médicales</h5>
                                    <p>Consultations gratuites avec des médecins généralistes et spécialistes bénévoles.</p>
                                </div>
                            </div>
                            <div class="event-action-item">
                                ...
                                <div>
                                    <h5>Vaccinations</h5>
                                    <p>Programme de vaccination pour enfants et adultes selon le calendrier vaccinal.</p>
                                </div>
                            </div>
                            <div class="event-action-item">
                                ...
                                <div>
                                    <h5>Distribution de Médicaments</h5>
                                    <p>Médicaments essentiels distribués gratuitement aux familles les plus vulnérables.</p>
                                </div>
                            </div>
                            <div class="event-action-item">
                                ...
                                <div>
                                    <h5>Santé Maternelle & Infantile</h5>
                                    <p>Suivi médical spécial pour les femmes enceintes, allaitantes et les nourrissons.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="event-detail-tags">
                        ...
                        <span class="etag"><i class="fas fa-pills"></i> Médicaments</span>
                    </div>
            ...
            <div class="col-lg-4 col-md-12">
                    ...
                    <div class="register-card-body">
                        ...
                        <div class="register-info-item">
                            ...
                            <div>
                                ...
                                <strong>Médecins & Infirmiers Bénévoles</strong>
                            </div>
                        </div>
                ...
                <div class="event-sidebar-card donate-card">
                    ...
                    <h4>Soutenez la Caravane</h4>
                    <p>Votre don finance les médicaments, le matériel médical et les frais logistiques de cet événement.</p>
