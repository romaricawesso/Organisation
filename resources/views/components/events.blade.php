    ...
    <div class="container">
        <div class="row mb-40">
            <div class="col-lg-12 text-center">
                ...
                <h2 class="event-section-title">Événements Passer</h2>
        ...
        <div class="event_active event_style_adn_3">
            ...
            <div class="event-list-card">
                ...
                <div class="event-list-body">
                    ...
                    <a href="{{ route('event.education') }}" class="event-list-btn">
            ...
            <div class="event-list-card">
                ...
                <div class="event-list-body">
                    ...
                    <a href="{{ route('event.sante') }}" class="event-list-btn">
                        Voir les Détails <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="event-list-card">
                ...
                <div class="event-list-body">
                    ...
                    <a href="{{ route('event.nutrition') }}" class="event-list-btn">
                        Voir les Détails <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
            </div>
