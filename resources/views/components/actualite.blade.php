...
<div class="breadcumb-area" style="background-image: url('{{ asset('assets/images/slider-01.jpg') }}'); background-size: cover; background-position: center; position: relative;">
    {{-- Overlay sombre --}}
